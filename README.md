...
After a bit of Googling, I found a couple of Canon file convertors. Unfortunately neither were suitable for my purpose, nor did they do batch conversion. I had 100 disks with many files on them. There was no way I wanted to do that manually. Nor did it solve the missing (aka invisible to DOS) files.
...
Next step was to write a basic Canon StarWriter file format converter. I didn't go all-in on this, just enough to be able to read the content of the files in a text editor. 

NB. None of the source code is presented there - The code was a means to an end, and not meant for public distribution.

# The Original Author

Most of the files were lists of aircraft information, but some were personal letters to other people, written by the original owner of these disks. I have of course NOT uploaded any of those to this collection (and I have since deleted them all). However from reading the letters I gleaned the following information about this collection:
...
- Based on the personal information I read, and that the disks were being sold by a house clearance company, I can only assume he died (of old age, maybe), without these new lists ever seeing the light of day.
...
- [US.ZIP](https://github.com/Jaruzel/CivMilAir-Two/raw/refs/heads/main/US.zip) : 2,213 Files
- [CIV.ZIP](https://github.com/Jaruzel/CivMilAir-Two/raw/refs/heads/main/CIV.ZIP) : 111 files
- [DH.ZIP](https://github.com/Jaruzel/CivMilAir-Two/raw/refs/heads/main/DH.ZIP) : 23 files
- [MISC.ZIP](https://github.com/Jaruzel/CivMilAir-Two/raw/refs/heads/main/MISC.zip) : 23 files
...
The US merged list is [US-FULL.CSV](https://github.com/Jaruzel/CivMilAir-Two/raw/refs/heads/main/US-FULL.CSV).
